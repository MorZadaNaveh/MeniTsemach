...
let TENDERS = [
  {id:0,name:'ביקורת פנימית שוטפת',org:'עיריית פתח תקווה',
   ...
   appTeam:[
     {name:'רון פישמן רו"ח',role:'מנהל ביקורת ראשי',id:'012345678',years:18,certs:'רו"ח, מבקר פנימי מוסמך (CIPA)',areas:'ביקורת פנימית, שכר, רכש'},
  ...
  {id:2,name:'ייעוץ כלכלי ובקרת תקציב',org:'עיריית נתניה',
   ...
   appTeam:[
     ...
     {name:'רון פישמן רו"ח',role:'חשב מלווה',id:'012345678',years:18,certs:'רו"ח, CIPA',areas:'ביקורת, כספים'}
   ]
  }
];

let teamMembers = [
  {name:'רון פישמן',title:'רו"ח',role:'שותף מנהל',years:18,color:'#1a5c4a',ini:'רפ',areas:['ביקורת פנימית','ביקורת שכר','ניהול סיכונים','רגולציה'],certs:['רו"ח','מבקר פנימי מוסמך (CIPA)']},
